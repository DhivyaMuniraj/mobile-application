package com.ces.androidframework.datastructuresandalgorithmhelper.sort
 ...
 */
fun <T : Comparable<T>> mergeSortPlain(list: MutableList<T>) =
    mergeSortPlain(list, 0, list.size - 1)
